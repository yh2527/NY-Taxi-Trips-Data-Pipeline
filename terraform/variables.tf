...
#bigQuery table name
variable "table_id_yellow" {
  description = "table_id for yellow tripdata (source: terraform.tfvars)"
  type        = string
}
variable "table_id_green" {
  description = "table_id for green tripdata (source: terraform.tfvars)"
  type        = string
}
